...
public class PointSystem : MonoBehaviour
{
    ...
    public void checkBuilding(){
        ...
        if (ironBuilding.Length >= 1 && furnaceBuilding.Length >= 1)
        {
            Debug.Log("Furnace dentro del point antes de llamar el show");
            Debug.Log(feedback.furnaceFeedback);
            feedback.showFurnaceFeedback();
        }
    }
    void obtainIron(){
